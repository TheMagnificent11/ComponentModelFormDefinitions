...
export function UsersByIdPutReducer(
    ...
    switch (action.type) {
        case actions.Actions.PUT_USER: return { ...state, loading: true, success: false, error: null };
        case actions.Actions.PUT_USER_SUCCESS: return { ...state, success: true, loading: false };
        case actions.Actions.PUT_USER_ERROR: return { ...state, success: false, error: action.payload, loading: false };
